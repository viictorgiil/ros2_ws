...
class MainWindow(QMainWindow):
    ...
    def __init__(self, bridge, node):
        ...
        bridge.robot_provisional_move.connect(self._board.on_robot_provisional_move)
    ...
    def _disconnect_bridge(self):
        ...
        try:
            ...
            self._bridge.robot_provisional_move.disconnect(self._board.on_robot_provisional_move)
